  ...
  render: () => (
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm mb-4">Icon on left, content flows horizontally</p>
...
export const AllVariants: Story = {
  render: () => (
    <div className="flex flex-col gap-8 max-w-4xl">
      ...
      {/* Card Buttons */}
      <div>
        <h3 className="text-lg font-semibold text-white mb-4">Card Buttons (Vertical Layout)</h3>
        <div className="grid grid-cols-3 gap-4">
          <Button
            variant="card"
            layout="vertical"
      ...
      {/* Checkbox Cards */}
      <div>
        <h3 className="text-lg font-semibold text-white mb-4">Checkbox Cards</h3>
        <div className="grid grid-cols-2 gap-4">
          <Button
            variant="checkbox-card"
            layout="vertical"
