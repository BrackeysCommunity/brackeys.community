              ...
              <div className="relative">
                <div className="bg-gradient-to-r from-brackeys-purple-600 to-brackeys-purple-800 px-6 py-4">
                  <Dialog.Title className="text-xl font-semibold text-white">
                    {isEdit ? 'Edit Collaboration Profile' : 'Create Collaboration Profile'}
                  </Dialog.Title>
                  <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={e =>
                        setFormData({ ...formData, contactPreferences: e.target.value })
                      }
                      rows={2}
                      className={cn(
                        'w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg',
                  ...
                  <div className="flex items-center justify-between">
                    <label className="text-sm font-medium text-gray-300">Make profile public</label>
                    <button
                      type="button"
