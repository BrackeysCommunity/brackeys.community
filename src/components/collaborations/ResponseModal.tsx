                ...
                <div className="p-6">
                  ...
                  <div className="bg-gray-900/50 rounded-lg p-4 mb-6">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-sm text-gray-400">Responding to:</span>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        This will only be visible to the post author unless you make your response
                        public
                      </p>
                    </div>
                      ...
                      <div className="flex items-start gap-3">
                        <button
                          ...
                          className={cn(
                            ...
                            formData.isPublic ? 'bg-brackeys-purple-600' : 'bg-gray-700'
                          )}
                        >
                          <span
                            className={cn(
                    ...
                    <div className="flex items-start gap-2 p-3 bg-yellow-900/20 border border-yellow-700/50 rounded-lg">
                      ...
                      <p className="text-xs text-yellow-200">
                        Please be respectful and professional in your response. Inappropriate
                        messages may result in restrictions on your collaboration privileges.
                      </p>
                    </div>
