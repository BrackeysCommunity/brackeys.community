...
export const Input = forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    return (
      <div
        className={`relative flex items-stretch bg-gray-700 border ${error ? 'border-red-500' : 'border-gray-600'} rounded-lg focus-within:ring-2 focus-within:ring-brackeys-purple-500 overflow-hidden`}
      >
        {prefixButton && (
          <>
            <div className="flex">{prefixButton}</div>
