...
import type { ResourceCategory, ResourceFilterProps } from './types';
...
export const CategoryFilter = ({
  ...
  const visibleCategories = Object.entries(categoryCounts).filter(
    ([category]) => {
  ...
  useEffect(() => {
    if (activeType !== 'all' && activeCategory !== 'all') {
      const activeCategoryInfo =
        categoryInfo[activeCategory as ResourceCategory];
                    ...
                    <AnimatePresence mode="popLayout">
                      {visibleCategories
                        ...
                        .map(([category, count], index) => {
                          const info =
                            categoryInfo[category as ResourceCategory];
                          return (
                            <motion.div
                              key={category}
                              initial="initial"
