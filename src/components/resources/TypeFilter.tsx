...
type TypeFilterProps = Pick<ResourceFilterProps, 'activeType' | 'setActiveType' | 'typeCounts'>;

export const TypeFilter = ({ activeType, setActiveType, typeCounts }: TypeFilterProps) => {
