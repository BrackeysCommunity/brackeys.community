...
/**
 * The five-step wizard, on the same drawer primitive as the post detail
 * and the filter panel — bottom sheet on touch, right-side panel on
 * desktop. It is the edit surface for a live post and the `?flow=wizard`
 * hatch for a new one; the board's own POST A ROLE opens the three-step
 * modal instead. The drawer owns dismissal (swipe, scrim, Esc), so the
 * panel carries no close button of its own; the draft is auto-saved, so
    ...
    >
      ...
      >
        ...
        <DrawerDescription className="sr-only">
          Create or edit a collaboration post: paid work or a hobby project.
        </DrawerDescription>
