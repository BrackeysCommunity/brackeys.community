...
export function ProfileEditForm({
  ...
  const [linkingProvider, setLinkingProvider] = useState<LinkProvider | null>(null);
  ...
  const [availableForWork, setAvailableForWork] = useState(profile.availableForWork ?? false);
  ...
  const handleLinkGitHub = async () => {
    ...
    try {
      ...
      if (
        ...
        const message =
          typeof err === "string" ? err : err.message || "Failed to start GitHub OAuth";
