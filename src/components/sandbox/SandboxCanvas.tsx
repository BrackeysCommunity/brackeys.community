      ...
      >
        ...
        <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-baseline pointer-events-none">
          <p className="text-xs text-gray-500">
            <kbd className="bg-gray-800 text-gray-400 px-1.5 py-0.5 rounded-md">/</kbd> to start
            typing
            {messagesEnabled && (
              <>
                {' '}
                • <kbd className="bg-gray-800 text-gray-400 px-1.5 py-0.5 rounded-md">Enter</kbd> to
                send
              </>
            )}{' '}
            • <kbd className="bg-gray-800 text-gray-400 px-1.5 py-0.5 rounded-md">ESC</kbd> to
            cancel
          </p>
        </div>
