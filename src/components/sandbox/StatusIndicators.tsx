    ...
    <>
      ...
      {roomCode && (
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-10">
          <button
            onClick={onRoomClick}
            className="flex items-center gap-2 bg-gray-900/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-gray-700 hover:bg-gray-800/80 transition-colors"
          >
            <span className="text-sm font-medium text-gray-300">Room: {roomCode}</span>
          </button>
        </div>
      )}
    </>
