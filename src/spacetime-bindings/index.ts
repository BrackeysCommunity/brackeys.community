...
export class RemoteReducers {
  ...
  cleanupOldMessages(arg: CleanupSchedule) {
    ...
    this.connection.callReducer(
      'cleanup_old_messages',
      __argsBuffer,
      this.setCallReducerFlags.cleanupOldMessagesFlags,
    );
  }

  onCleanupOldMessages(
    callback: (ctx: ReducerEventContext, arg: CleanupSchedule) => void,
  ) {
    this.connection.onReducer('cleanup_old_messages', callback);
  }

  removeOnCleanupOldMessages(
    callback: (ctx: ReducerEventContext, arg: CleanupSchedule) => void,
  ) {
  ...
  dismissMessage(messageId: bigint) {
    ...
    this.connection.callReducer(
      'dismiss_message',
      __argsBuffer,
      this.setCallReducerFlags.dismissMessageFlags,
    );
  }

  onDismissMessage(
    callback: (ctx: ReducerEventContext, messageId: bigint) => void,
  ) {
    this.connection.onReducer('dismiss_message', callback);
  }

  removeOnDismissMessage(
    callback: (ctx: ReducerEventContext, messageId: bigint) => void,
  ) {
  ...
  joinRoom(roomCode: string, passwordHash: string) {
    ...
    this.connection.callReducer(
      'join_room',
      __argsBuffer,
      this.setCallReducerFlags.joinRoomFlags,
    );
  }
  ...
  onSetDisplayName(
    callback: (ctx: ReducerEventContext, name: string, color: string) => void,
  ) {
    this.connection.onReducer('set_display_name', callback);
  }

  removeOnSetDisplayName(
    callback: (ctx: ReducerEventContext, name: string, color: string) => void,
  ) {
  ...
  updateColor(color: string) {
    ...
    this.connection.callReducer(
      'update_color',
      __argsBuffer,
      this.setCallReducerFlags.updateColorFlags,
    );
  }
  ...
  updateRoomConfig(messageTtlSeconds: number, messagesEnabled: boolean) {
    ...
    this.connection.callReducer(
      'update_room_config',
      __argsBuffer,
      this.setCallReducerFlags.updateRoomConfigFlags,
    );
  }
...
export class RemoteTables {
  ...
  get cleanupSchedule(): CleanupScheduleTableHandle {
    return new CleanupScheduleTableHandle(
      this.connection.clientCache.getOrCreateTable<CleanupSchedule>(
        REMOTE_MODULE.tables.cleanup_schedule,
      ),
    );
  }
  ...
  get liveTyping(): LiveTypingTableHandle {
    return new LiveTypingTableHandle(
      this.connection.clientCache.getOrCreateTable<LiveTyping>(
        REMOTE_MODULE.tables.live_typing,
      ),
    );
  }
  ...
  get room(): RoomTableHandle {
    return new RoomTableHandle(
      this.connection.clientCache.getOrCreateTable<Room>(
        REMOTE_MODULE.tables.room,
      ),
    );
  }

  get sandboxMessage(): SandboxMessageTableHandle {
    return new SandboxMessageTableHandle(
      this.connection.clientCache.getOrCreateTable<SandboxMessage>(
        REMOTE_MODULE.tables.sandbox_message,
      ),
    );
  }
  ...
  get sandboxUser(): SandboxUserTableHandle {
    return new SandboxUserTableHandle(
      this.connection.clientCache.getOrCreateTable<SandboxUser>(
        REMOTE_MODULE.tables.sandbox_user,
      ),
    );
  }
}
