...
export const DEFAULT_BINDINGS: InputBinding[] = [
  ...
  { action: "grapple", keys: ["e"] },
];

// ─── Debug ───────────────────────────────────────────────

export type DebugMode = "off" | "grid" | "grid+physics" | "grid+physics+arcs" | "all";

export const DEBUG_MODES: DebugMode[] = ["off", "grid", "grid+physics", "grid+physics+arcs", "all"];
