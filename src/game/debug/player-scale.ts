...
export function createPlayerScaleRef(): PlayerScaleRef {
	...
	function drawCornerRef(): void {
		...
		cornerGraphics.setStrokeStyle({ width: OUTLINE_WIDTH, color: OUTLINE_COLOR, alpha: OUTLINE_ALPHA })
	...
	function update(mouseWorldX: number, mouseWorldY: number): void {
		...
		cursorGraphics.setStrokeStyle({ width: OUTLINE_WIDTH, color: OUTLINE_COLOR, alpha: OUTLINE_ALPHA * 0.7 })
		drawDashedRect(
			cursorGraphics,
