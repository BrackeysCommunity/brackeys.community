  ...
  return (
    <div className="pointer-events-auto flex min-h-[50vh] flex-col items-center justify-center gap-8">
      <div className="space-y-3 text-center">
        ...
        <h1 className="font-display text-2xl tracking-tight text-foreground">Transformice</h1>
      ...
      <div className="flex flex-col items-center gap-3">
        <Link
          ...
          className="border border-primary/40 px-6 py-3 text-xs tracking-widest text-primary uppercase transition-colors hover:bg-primary/10"
        >
          Enter Test Room →
        </Link>
