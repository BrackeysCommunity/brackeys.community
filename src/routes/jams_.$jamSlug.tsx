  ...
  head: ({ loaderData }) => {
    ...
    return {
      ...
      scripts: [
        ...
        ...componentEmbed(
          jamLinkPreview(jam, {
            // The host's own blurb, on its own — the only thing the
            // generated card doesn't already say. `description` above folds
            // the dates and counts into the same string for the meta tag,
            // and the card prints those itself.
