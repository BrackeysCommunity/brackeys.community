...
export const useAltAccountsQuery = <TData = AltAccountsQuery, TError = unknown>(
  ...
  options?: Omit<
    UseQueryOptions<AltAccountsQuery, TError, TData>,
    'queryKey'
  > & {
  ...
  return useQuery<AltAccountsQuery, TError, TData>({
    queryKey:
      variables === undefined ? ['AltAccounts'] : ['AltAccounts', variables],
...
>(
  ...
  options?: Omit<
    UseQueryOptions<CollaborationTypesQuery, TError, TData>,
    'queryKey'
  > & {
...
>(
  ...
  options?: Omit<
    UseQueryOptions<HiringStatusesQuery, TError, TData>,
    'queryKey'
  > & {
...
>(
  ...
  options?: Omit<
    UseQueryOptions<CollaborationStatusesQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
  ...
  return useQuery<CollaborationStatusesQuery, TError, TData>({
    queryKey:
      variables === undefined
        ...
        : ['CollaborationStatuses', variables],
    queryFn: fetcher<
      CollaborationStatusesQuery,
...
>(
  ...
  options?: Omit<
    UseQueryOptions<MyCollaborationProfileQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
...
>(
  ...
  options?: Omit<
    UseQueryOptions<CollaborationProfileByIdQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
...
>(
  ...
  options?: Omit<
    UseQueryOptions<CollaborationPostsQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
...
>(
  ...
  options?: Omit<
    UseQueryOptions<CollaborationPostDetailQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
...
>(
  ...
  options?: Omit<
    UseQueryOptions<CollaborationFieldDefinitionsQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
...
useCollaborationFieldDefinitionsQuery.document =
  CollaborationFieldDefinitionsDocument;
...
>(
  ...
  options?: Omit<
    UseQueryOptions<MyCollaborationResponsesQuery, TError, TData>,
    'queryKey'
  > & {
    queryKey?: UseQueryOptions<
...
>(
  ...
  options?: Omit<
    UseQueryOptions<PostResponsesQuery, TError, TData>,
    'queryKey'
  > & {
...
export const useMyBookmarksQuery = <TData = MyBookmarksQuery, TError = unknown>(
  ...
  options?: Omit<
    UseQueryOptions<MyBookmarksQuery, TError, TData>,
    'queryKey'
  > & {
