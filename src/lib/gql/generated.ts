...
export type MyCollaborationProfileQuery = {
  collaborationProfile?: Array<{
    ...
    collaborationResponses?: Array<{ id: any; collaborationPostId: any; isRead: any }> | null;
    collaborationBookmarks?: Array<{ id: any; collaborationPostId: any }> | null;
  }> | null;
};
...
export type CollaborationProfileByIdQuery = {
  collaborationProfileById?: {
    ...
    collaborationPosts?: Array<{
      ...
      responseCount: any;
      tags?: any | null;
      collaborationType?: { name: any } | null;
      hiringStatus?: { name: any } | null;
      collaborationFieldValues?: Array<{
        id: any;
        value: any;
        collaborationFieldDefinition?: { id: any; fieldName: any; displayName: any } | null;
      }> | null;
    }> | null;
  } | null;
};
...
export type CollaborationPostsQuery = {
  collaborationPost?: Array<{
    ...
    isHighlighted: any;
    tags?: any | null;
    collaborationProfile?: { id: any; displayName?: any | null; userId: any } | null;
    collaborationType?: { id: any; name: any } | null;
    hiringStatus?: { id: any; name: any } | null;
    collaborationStatus?: { id: any; name: any } | null;
    collaborationFieldValues?: Array<{
      id: any;
      value: any;
    ...
    collaborationBookmarks?: Array<{ profileId: any }> | null;
  }> | null;
  collaborationPostAggregate?: { _count: number } | null;
};
...
export type CollaborationPostDetailQuery = {
  collaborationPostById?: {
    ...
    collaborationType?: { id: any; name: any; description?: any | null } | null;
    hiringStatus?: { id: any; name: any; description?: any | null } | null;
    collaborationStatus?: { id: any; name: any; description?: any | null } | null;
    collaborationFieldValues?: Array<{
      id: any;
      value: any;
      collaborationFieldDefinition?: {
...
export type MyCollaborationResponsesQuery = {
  collaborationResponse?: Array<{
    ...
    collaborationPost?: {
      id: any;
      statusId: any;
      collaborationProfile?: { displayName?: any | null } | null;
      collaborationType?: { name: any } | null;
      hiringStatus?: { name: any } | null;
    } | null;
  }> | null;
...
export type MyBookmarksQuery = {
  collaborationBookmark?: Array<{
    ...
    collaborationPost?: {
      ...
      collaborationFieldValues?: Array<{
        value: any;
        collaborationFieldDefinition?: { fieldName: any; displayName: any } | null;
      }> | null;
    } | null;
  }> | null;
};
...
export const useAltAccountsQuery = <TData = AltAccountsQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: AltAccountsQueryVariables,
  options?: Omit<UseQueryOptions<AltAccountsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<AltAccountsQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<AltAccountsQuery, TError, TData>({
    queryKey: variables === undefined ? ['AltAccounts'] : ['AltAccounts', variables],
    queryFn: fetcher<AltAccountsQuery, AltAccountsQueryVariables>(
      dataSource.endpoint,
...
export const useCollabsQuery = <TData = CollabsQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: CollabsQueryVariables,
  options?: Omit<UseQueryOptions<CollabsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<CollabsQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<CollabsQuery, TError, TData>({
    queryKey: variables === undefined ? ['Collabs'] : ['Collabs', variables],
    queryFn: fetcher<CollabsQuery, CollabsQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      CollabsDocument,
      variables
...
export const useCollaborationTypesQuery = <TData = CollaborationTypesQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: CollaborationTypesQueryVariables,
  options?: Omit<UseQueryOptions<CollaborationTypesQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<CollaborationTypesQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<CollaborationTypesQuery, TError, TData>({
    ...
    queryFn: fetcher<CollaborationTypesQuery, CollaborationTypesQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      CollaborationTypesDocument,
      variables
    ),
    ...options,
  });
...
export const useHiringStatusesQuery = <TData = HiringStatusesQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: HiringStatusesQueryVariables,
  options?: Omit<UseQueryOptions<HiringStatusesQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<HiringStatusesQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<HiringStatusesQuery, TError, TData>({
    queryKey: variables === undefined ? ['HiringStatuses'] : ['HiringStatuses', variables],
    queryFn: fetcher<HiringStatusesQuery, HiringStatusesQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      HiringStatusesDocument,
      variables
    ),
    ...options,
  });
...
export const useCollaborationStatusesQuery = <TData = CollaborationStatusesQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: CollaborationStatusesQueryVariables,
  options?: Omit<UseQueryOptions<CollaborationStatusesQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<CollaborationStatusesQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<CollaborationStatusesQuery, TError, TData>({
    queryKey:
      variables === undefined ? ['CollaborationStatuses'] : ['CollaborationStatuses', variables],
    queryFn: fetcher<CollaborationStatusesQuery, CollaborationStatusesQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      CollaborationStatusesDocument,
      variables
    ),
    ...options,
  });
...
>(
  ...
  options?: Omit<UseQueryOptions<MyCollaborationProfileQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<MyCollaborationProfileQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<MyCollaborationProfileQuery, TError, TData>({
    queryKey: ['MyCollaborationProfile', variables],
    queryFn: fetcher<MyCollaborationProfileQuery, MyCollaborationProfileQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      MyCollaborationProfileDocument,
      variables
    ),
    ...options,
  });
...
>(
  ...
  options?: Omit<UseQueryOptions<CollaborationProfileByIdQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<CollaborationProfileByIdQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<CollaborationProfileByIdQuery, TError, TData>({
    queryKey: ['CollaborationProfileById', variables],
    queryFn: fetcher<CollaborationProfileByIdQuery, CollaborationProfileByIdQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      CollaborationProfileByIdDocument,
      variables
    ),
    ...options,
  });
...
export const useCollaborationPostsQuery = <TData = CollaborationPostsQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables?: CollaborationPostsQueryVariables,
  options?: Omit<UseQueryOptions<CollaborationPostsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<CollaborationPostsQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<CollaborationPostsQuery, TError, TData>({
    ...
    queryFn: fetcher<CollaborationPostsQuery, CollaborationPostsQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      CollaborationPostsDocument,
      variables
    ),
    ...options,
  });
...
>(
  ...
  options?: Omit<UseQueryOptions<CollaborationPostDetailQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<CollaborationPostDetailQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<CollaborationPostDetailQuery, TError, TData>({
    queryKey: ['CollaborationPostDetail', variables],
    queryFn: fetcher<CollaborationPostDetailQuery, CollaborationPostDetailQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      CollaborationPostDetailDocument,
      variables
    ),
    ...options,
  });
...
>(
  ...
  options?: Omit<UseQueryOptions<CollaborationFieldDefinitionsQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<CollaborationFieldDefinitionsQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<CollaborationFieldDefinitionsQuery, TError, TData>({
    ...
    >(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      CollaborationFieldDefinitionsDocument,
      variables
    ),
    ...options,
  });
...
>(
  ...
  options?: Omit<UseQueryOptions<MyCollaborationResponsesQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<MyCollaborationResponsesQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<MyCollaborationResponsesQuery, TError, TData>({
    queryKey: ['MyCollaborationResponses', variables],
    queryFn: fetcher<MyCollaborationResponsesQuery, MyCollaborationResponsesQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      MyCollaborationResponsesDocument,
      variables
    ),
    ...options,
  });
...
export const usePostResponsesQuery = <TData = PostResponsesQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables: PostResponsesQueryVariables,
  options?: Omit<UseQueryOptions<PostResponsesQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<PostResponsesQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<PostResponsesQuery, TError, TData>({
    queryKey: ['PostResponses', variables],
    queryFn: fetcher<PostResponsesQuery, PostResponsesQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      PostResponsesDocument,
      variables
    ),
    ...options,
  });
...
export const useMyBookmarksQuery = <TData = MyBookmarksQuery, TError = unknown>(
  dataSource: { endpoint: string; fetchParams?: RequestInit },
  variables: MyBookmarksQueryVariables,
  options?: Omit<UseQueryOptions<MyBookmarksQuery, TError, TData>, 'queryKey'> & {
    queryKey?: UseQueryOptions<MyBookmarksQuery, TError, TData>['queryKey'];
  }
) => {
  return useQuery<MyBookmarksQuery, TError, TData>({
    queryKey: ['MyBookmarks', variables],
    queryFn: fetcher<MyBookmarksQuery, MyBookmarksQueryVariables>(
      dataSource.endpoint,
      dataSource.fetchParams || {},
      MyBookmarksDocument,
      variables
