 ...
 * stay comfortably above the lifecycle sweep's interval (6h today, the
 * `lifecycle_sweep` repeatable job in `services/notifications-worker`). Lowering it toward that interval
