...
export const resources: ResourceItem[] = [
  // Games
  {
    ...
    resourceUrl: new URL(
      'https://computer-q.itch.io/brackeys-13-nothing-can-go-wrong',
    ),
  },
  {
    id: 'amalgablade',
  ...
  },
  {
    ...
    developerUrl: 'https://qntn.be/',
    resourceUrl: new URL(
      'https://computer-q.itch.io/brackeys-12-calm-before-the-storm',
    ),
  },
  {
    ...
    description:
      'Mix potions and defeat enemies in this strategic alchemy game.',
