...
export const marcoMacros: Macro[] = [
  {
    ...
    "description": "When chat dies, it's a good time to be productive instead of finding an excuse to not be productive; go for a walk, get water, say hi to loved ones, take a shower, clean your room, or even exercise!"
  },
  {
    "name": "source",
    "aliases": [],
  ...
  },
  {
    ...
    "description": "Please don't crosspost! Be patient when you ask your question, we all have questions and there are only so many people to answer them. Posting in multiple channels is spamming and doesn't help anyone."
  },
  {
    "name": "channels",
    "aliases": [],
  ...
  },
  {
    ...
    "aliases": [],
    "description": "Due to security issues with the BinaryFormatter, it should not be used in any case.\nhttps://docs.microsoft.com/en-us/dotnet/standard/serialization/binaryformatter-security-guide"
  },
  {
    "name": "learncpp",
    "aliases": [],
    "description": "Great youtube tutorial series: <https://www.youtube.com/playlist?list=PLlrATfBNZ98dudnM48yfGUldqGD0S4FFb>\nC++ reference: <https://en.cppreference.com/w/>"
  },
  {
    "name": "learnshaders",
    "aliases": [
  ...
  },
  {
    ...
    "description": "__**We Are Not Lawyers**__\nWe are a community of game dev and programming enthusiasts, and should not be a substitute for professional legal advice.\n\nDo not take legal advice from random strangers on the internet. Please consult with a lawyer."
  },
  {
    "name": "helpchat",
    "aliases": [],
    "description": "<#1233892569503760486> is for brief questions with quick answers. If you have a complicated question or want focused attention, use the Development & Help category (see <#552209553886806046>)"
  },
  {
    "name": "rule",
    "aliases": [],
    "description": "The `[]rule` command is no longer in use. Use the `/rule` slash command to display rules."
  },
  {
    "name": "deop",
    "aliases": [],
  ...
  },
  {
    "name": "imageperms",
    "aliases": [
      "wherethehellismyembed",
      "whycantipostlinks",
      "whycantipostimages"
    ],
    "description": "Due to a recent onslaught of NSFW spammers, image and link permissions have been temporarily restricted. We apologise for the inconvenience. If the staff judge you to be trustworthy, you will be granted these permissions."
  },
  {
    "name": "mellowho",
    "aliases": [],
